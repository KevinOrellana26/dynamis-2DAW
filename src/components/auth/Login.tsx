...
// ! FALTA AÑADIR EL NEXTAUTH, ZOD Y TYPESCRIPT, si pulsa en crear cuenta (home) que redirija directamente al formulario de registrarse

function Login() {

  const [currentTab, setCurrentTab] = useState<DescriptionType>("iniciar-sesion");
  ...
  return (
    <Card className="p-8 md:p-20 w-full max-w-xl mx-auto">
      <CardHeader>
